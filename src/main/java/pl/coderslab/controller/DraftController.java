...
public class DraftController {
    ...
    public String postAddArticle(@Validated({ValidationDraft.class}) Article article, BindingResult result){
        if (result.hasErrors()){
            return "draft/draftForm";
        }
    ...
    public String postEditArticle(@Validated({ValidationDraft.class}) Article article, BindingResult result){
        if (result.hasErrors()){
            return "draft/draftEditForm";
        }
